<div class="">
    ...
    <div class="add-body bg-light p-5">
        <form action="<?= url('genre/update/'. $data['get-genre']['id_genre']) ?>" method="post" >
            <div class=""><?php Flasher::flash() ?></div>
            <div class="d-flex justify-content-center row">
                <div class="mb-3 col-6">
                    <label for="exampleFormControlInput1" class="form-label">Nama Genre</label>
                    <input type="text" name="genre_name" id="name" value="<?= $data['get-genre']['nama_genre'] ?>" class="form-control" id="exampleFormControlInput1" placeholder="Masukan Nama Genre...">
                </div>
                <div class="mb-3 col-6">
                    <label for="exampleFormControlInput1" class="form-label">Slug Genre</label>
                    <input type="text" name="genre_slug" id="slug" value="<?= $data['get-genre']['slug_genre'] ?>" class="form-control" id="exampleFormControlInput1" placeholder="Masukan Slug Genre...">
                </div>
            </div>
            <div class="form-floating mb-3">
                <textarea class="form-control" name="genre_desc" placeholder="Leave a comment here" id="floatingTextarea" style="height: 150px;"><?= $data['get-genre']['description']; ?></textarea>
